...
function Signup({ onClose, onSwitchToLogin }: SignupProps) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="w-[400px] relative">
        ...
        <div className="bg-white rounded-xl shadow-xl border border-slate-100 p-8 aspect-[3/5] flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5">
            ...
            <div className="flex items-start pt-1">
              <input
                type="checkbox"
                required
                className="w-3.5 h-3.5 rounded border-slate-300 text-green-600 focus:ring-green-500 mt-0.5"
              />
              <span className="ml-2 text-xs text-slate-600">
                I agree to the{" "}
                <Link to="/terms-conditions" className="text-green-600 hover:text-green-700 font-medium">
                  Terms
                </Link>{" "}
                and{" "}
