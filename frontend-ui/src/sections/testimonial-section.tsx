...
export default function TestimonialSection() {
    ...
    const CreateCard = ({ card }: { card: CardProps }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">Sold my old newspapers and got paid instantly! Best rates in the market. Highly recommend KabadiShop.</p>
        </div>
    );
    ...
    return (
        <>
            <SectionTitle
                ...
                description="See what our customers say about selling scrap with KabadiShop."
            />
