    ...
    return (
        <>
            <SectionTitle
                ...
                badge="How it works"
                title="Sell Scrap in 3 Easy Steps"
                description="From pickup request to payment, KabadiShop makes selling your recyclable materials simple and profitable."
            />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Schedule Pickup</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Book a free doorstep pickup at your convenience. Our team collects scrap from your location.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Get Best Price</h3>
                                <p className="text-sm text-slate-600 max-w-xs">We weigh your scrap accurately and offer competitive market rates for all recyclable materials.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Instant Payment</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Receive immediate payment via cash, UPI, or bank transfer once the transaction is complete.</p>
                            </div>
                        </div>
                    </div>
                </div>
