    ...
    return (
        <div className="w-full max-w-xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 relative my-4">
                <button onClick={onClose} className="absolute -top-3 -right-3 bg-white rounded-full p-2 shadow-lg border border-slate-200 hover:bg-red-50 hover:border-red-300 transition group z-10">
                ...
                <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <p className="text-sm sm:text-base text-slate-600 text-center mb-6">Login to your account</p>
                    ...
                    <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between text-xs sm:text-sm">
                            ...
                            <button type="button" className="text-green-600 hover:text-green-700">Forgot password?</button>
                        </div>
                    ...
                    <p className="text-center text-slate-600 text-xs sm:text-sm mt-4 sm:mt-6">
                        Don't have an account? <button onClick={onSwitchToSignup} className="text-green-600 hover:text-green-700 font-medium">Sign up</button>
                    </p>
                </div>
            </div>
        </div>
